<?php
# Template:	check_mk-ups_bypass.freq.php
...
$ds_name[1] = "Bypass frequency";
$opt[1] = "--vertical-label 'Hz' --title \"$hostname / $servicedesc\" ";

$def[1] = "DEF:f=$RRDFILE[1]:$DS[1]:AVERAGE ";
$def[1] .= "LINE:f#050:\"bypass frequency\" ";
$def[1] .= "GPRINT:f:LAST:\"%4.1lfHz last\" ";
$def[1] .= "GPRINT:f:MIN:\"%4.1lfHz min\" ";
$def[1] .= "GPRINT:f:MAX:\"%4.1lfHz max\" ";
